...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Gouri-Biju" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/gouri-biju/" },
  { icon: Instagram, link: "https://www.instagram.com/_g_o.u_ri_/?hl=id" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
Creating full-stack and AI-powered solutions to solve real-world challenges.
                </p>
