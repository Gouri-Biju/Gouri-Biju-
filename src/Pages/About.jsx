...
Delivering end-to-end applications where full-stack meets AI innovation.   <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const AboutPage = () => {
    ...
    },
 {
    icon: Globe,
    color: "from-[#6366f1] to-[#a855f7]",
    value: 3, // since you have 3 live apps deployed
    label: "Live Projects",
    description: "Production-ready apps deployed",
    animation: "fade-left",
  },
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
A Software Developer from Kochi, India, specializing in Python, Django, Flutter, and AI/ML.
I design and build full-stack web and mobile applications, along with AI-powered solutions that address real-world challenges. My work goes beyond learning — I have deployed multiple live projects, demonstrating my ability to deliver production-ready, end-to-end solutions.

I thrive on problem-solving, adaptability, and continuous learning, always striving to create impactful digital experiences that make a difference.            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Technology should empower, not just function — that’s why I build."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/10TvKTPlZR9xTDqHroeTNT4y_FnthSObM/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
